...
public class SpringBootServiceImpl implements SpringBootService {
    ...
    /*@Override
    public String getPath(Integer id) throws IOException, TimeoutException {
       // String path = //Data Collection Dipatcher aufrufen
        ...
        System.out.println("TEST getPath: " + message.get());
        return message.get(); //return path;
    }*/
    ...
    public synchronized String getPath(Integer id) throws IOException, TimeoutException {
        ...
        Object lock = new Object(); // Synchronisationsobjekt
        ...
        System.out.println("Rückgabe: " + messageWrapper.getValue());
